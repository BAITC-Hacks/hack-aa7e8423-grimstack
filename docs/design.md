...
Проектное описание сервиса GrimStack: архитектура, расчёт заказа, контракты и план реализации.

![Python 3.12](https://img.shields.io/badge/Python-3.12-3776AB?style=for-the-badge&logo=python&logoColor=white)
![FastAPI 0.141.1](https://img.shields.io/badge/FastAPI-0.141.1-009688?style=for-the-badge&logo=fastapi&logoColor=white)
...
- [3. Данные](#3-данные)
- [4. Алгоритм `analyze`](#4-алгоритм-analyze)
- [5. Демо-SKU (проверены по данным)](#5-демо-sku-проверены-по-данным)
- [6. Контракт](#6-контракт)
- [7. Интерфейс (владелец Ф)](#7-интерфейс-владелец-ф)
- [8. AI-слой (владелец А)](#8-ai-слой-владелец-а)
- [9. Проверка](#9-проверка)
- [10. Контрольные точки](#10-контрольные-точки)
- [11. Ограничения (для README)](#11-ограничения-для-readme)
...
Фактура по данным, на которую опирается этот документ, — в `docs/data-profile.md`.
...
же репозитория. Отдельного сервера БД нет: прогоны живут в памяти процесса, утверждения — в SQLite `var/app.db`. Развёрнутой публичной версии нет: проект проверяется
локальным запуском.
...
описаны в `docs/data-profile.md`, §1–2.
