...
Требования к HTTP API, хранению расчётов, обработке ошибок и экспорту заказов в XLSX.

**Статус:** исходное задание для исполнителя Б. Описания моков и контрольные точки
...
- [Интерфейсы ядра](#интерфейсы-ядра)
